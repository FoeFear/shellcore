...
public class EMP : WeaponAbility
{
    ...
    public static readonly int empDamage = 225;
    ...
    protected override void Awake()
    {
        ...
        base.Awake();
        abilityName = "EMP";
        description = $"Instant attack that deals and drains {damage} damage and energy.";
    ...
    protected override bool Execute(Vector3 victimPos)
    {
        ...
        AudioManager.PlayClipByID("clip_emp", transform.position);
        var residue = targetingSystem.GetTarget().GetComponent<IDamageable>().TakeShellDamage(GetDamage(), 0, GetComponentInParent<Entity>());
        targetingSystem.GetTarget().GetComponent<Entity>().TakeEnergy(GetDamage());
